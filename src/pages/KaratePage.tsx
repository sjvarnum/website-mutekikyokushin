...
const KaratePage: React.FC = () => (
  <>
    <Navigation />
    <section className="karate-page-section bg-light py-5 min-vh-75">
        ...
        <div className="row align-items-center g-5 flex-lg-row flex-column-reverse">
          <div className="col-lg-6 col-12 text-center">
            <img
              ...
              className="img-fluid rounded karate-page-section__image mb-4 mb-lg-0"
          ...
          <div className="col-lg-6 col-12">
            ...
            <h2 className="h5 theme-text-blue mb-4">The Strongest Karate – Tradition & Spirit</h2>
            ...
            <Link to="/" className="btn btn-outline-blue btn-lg mt-2">
              ← Back to Home
            </Link>
          </div>
        </div>
    ...
    <section className="karate-page-section__early-life bg-white border-bottom py-5">
      <div className="container">
        <div className="row align-items-center g-5 flex-lg-row flex-column-reverse">
          <div className="col-lg-6 col-12 text-center">
            <div className="img-fluid rounded bg-secondary bg-opacity-10 karate-page-section__image d-flex align-items-center justify-content-center mx-auto mb-4 mb-lg-0" style={{width: '100%', maxWidth: 400, height: 260}}>
              <span className="text-muted">[Early Life Image]</span>
            </div>
          </div>
          <div className="col-lg-6 col-12">
      ...
      <div className="container">
        <div className="row align-items-center g-5">
          <div className="col-lg-6 col-12 order-lg-2 text-center">
            <div className="img-fluid rounded bg-secondary bg-opacity-10 karate-page-section__image d-flex align-items-center justify-content-center mx-auto mb-4 mb-lg-0" style={{width: '100%', maxWidth: 400, height: 260}}>
              <span className="text-muted">[Mountain Training Image]</span>
            </div>
          </div>
    ...
    <section className="karate-page-section__legacy bg-white py-5">
      <div className="container">
        <div className="row align-items-center g-5 flex-lg-row flex-column-reverse">
          <div className="col-lg-6 col-12 text-center">
            <div className="img-fluid rounded bg-secondary bg-opacity-10 karate-page-section__image d-flex align-items-center justify-content-center mx-auto mb-4 mb-lg-0" style={{width: '100%', maxWidth: 400, height: 260}}>
              <span className="text-muted">[Kyokushin Legacy Image]</span>
            </div>
          </div>
          <div className="col-lg-6 col-12">
    ...
    {/* --- CTA Section --- */}
    <section className="karate-page-section__cta bg-light py-5 border-top">
      <div className="container text-center">
        <h2 className="display-6 theme-text-red mb-3">Ready to Experience Kyokushin?</h2>
        <p className="lead mb-4 theme-text-blue">
        ...
        <a href="/#contact" className="btn btn-solid-blue btn-lg shadow">
