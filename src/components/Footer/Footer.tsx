      ...
      <div className="row align-items-center gy-4">
        ...
        <div className="col-12 col-md-3 text-md-start mb-3 mb-md-0">
          <div className="footer__section">
            ...
            <div className="d-flex align-items-center justify-content-md-start gap-2 mb-2">
              ...
              <a
                href="viber://add?number=15853056003"
                aria-label="Viber"
                className="footer__icon-link"
              >
                <FaViber color="#7360F2" size={20} />
              </a>
              <a
                href="https://wa.me/15853056003"
                aria-label="WhatsApp"
                className="footer__icon-link"
              >
            ...
            <div>
              <a
                href="mailto:rcruz001@rochester.rr.com"
                className="footer__link"
              >
                rcruz001@rochester.rr.com
              </a>
              <br />
              <a
                href="mailto:ringwars.cruz2@gmail.com"
                className="footer__link"
              >
                ringwars.cruz2@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-3 text-md-start mb-3 mb-md-0">
          <div className="footer__section">
            ...
            <div>
              Village Gate Square, #274 N.
              <br />
              Goodman Street, Unit D240,
              <br />
              Rochester, New York
            </div>
          </div>
        ...
        <div className="col-12 col-md-3 text-md-start">
          <div className="footer__section">
            ...
            <div className="d-flex justify-content-md-start gap-3">
              {/* <a href="https://www.facebook.com/CruzNY/" aria-label="Facebook" className="footer__icon-link" target="_blank" rel="noopener noreferrer"><FaFacebookF color="#4267B2" size={28} /></a> */}
              <a
                href="https://www.instagram.com/muteki_kyokushin_new_york/"
                aria-label="Instagram"
                className="footer__icon-link"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaInstagram color="#0095F6" size={28} />
              </a>
